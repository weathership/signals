...
def test_catalog_has_federation_peers() -> None:
    ...
    assert "gaius.fmp.warehouse" in cats
    assert cats["gaius.fmp.warehouse"]["peer"] == "gaius"
    assert cats["gaius.fmp.warehouse"]["leaf"] == "root.platform"
    assert "warehouse.v_fmp_" in cats["gaius.fmp.warehouse"]["agent_focus"]
