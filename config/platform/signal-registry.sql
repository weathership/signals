...
INSERT INTO catalog_tables (db_name, table_name, table_type, parameters) VALUES
  ...
  ('signals_dataproducts', 'fmp_profile_tier0', 'KUDU',
   '{"kudu.table_name": "impala::signals_dataproducts.fmp_profile_tier0", "kudu.master_addresses": "tinybox.dev.vista.zndx.org:7051", "signals.tier": "0", "signals.range_unit": "day", "signals.product": "gaius.fmp.warehouse"}'),
  ('signals_dataproducts', 'fmp_filings_tier0', 'KUDU',
